    ...
    for i_ep in range(n_ep):
        ...
        for batch_data in train_loader:
            ...
            if np.random.randint(2):
                ...
                optimizer_mini = torch.optim.Adam([x], weight_decay=1e-5, lr=100)
                for i in range(1):
                    model.eval()
                    logits = model(x)
...
def train_cnn_model(model_name, gpu_ids, batch_size):
    ...
    dataset_dir = '/home/wangzhaowei/rongyf/data/IJCAI_2019_AAAC_train_processed'
...
if __name__ == '__main__':
    ...
    train_cnn_model('pnasnet5large_110class', gpu_ids, batch_size)
